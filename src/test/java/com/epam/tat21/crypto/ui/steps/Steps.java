...
public class Steps {
    ...
    public synchronized PortfolioPage deleteUserPortfolio() {
        return portfolioPage.
                getEditPortfolioForm().
                deleteUserPortfolio().
                confirmDeletion();
    ...
    public void addCoinToUserPortfolio(Coin coin, String amount, String price) {
        portfolioPage.getAddCoinForm().addCoinInPortfolio(coin, amount, price);
    }
