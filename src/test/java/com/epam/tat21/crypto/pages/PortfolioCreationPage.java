...
public class PortfolioCreationPage extends HeaderPage {
	...
	public PortfolioCreationPage(WebDriver driver) {
		super(driver);
	}

	@Override
	public PortfolioCreationPage openPage() {
	...
	public PortfolioCreationPage createNewPortfolio(String name, String currency, String description) {
